...
<div class="es-wrap">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-hover">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="http://xuantong.cn/course/explore"  target="_blank">单阶课程</a></li>
                                <li><a href="http://xuantong.cn/classroom/explore"  target="_blank">全阶课程</a></li>
                                <li><a href="http://www.xuantong.cn/page/guidepc2"  target="_blank">报名指南</a></li>
                                <li><a href="http://www.xuantong.cn/page/guidepc3"  target="_blank">听课指南</a></li>
                                <li><a href="http://www.xuantong.cn/page/QA"  target="_blank">常见问题解答</a></li>
                                <li><a href="http://www.xuantong.cn/page/workPC"  target="_blank">提交作业&amp;下载资料指南</a></li>
                            </ul>
                        </li>
                        <li class="">
                        ...
                        <li class="nav-hover">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="https://h5.youzan.com/wscshop/feature/34c5XlwxGR?redirect_count=1"  target="_blank">购买暄桐文房</a></li>
                                <li><a href="https://item.taobao.com/item.htm?spm=a1z10.5-c-s.w4002-15726745250.24.525457c7NOuT1G&amp;id=581113349594"  target="_blank">购买文房文具包</a></li>
                                <li><a href="http://www.xuantong.cn/page/protect"  target="_blank">文房的养护</a></li>
                                <li><a href="https://shop114039340.taobao.com/category-1001045259.htm?spm=2013.1.w5002-15726745217.5.11e56141qoMrl5&amp;search=y&amp;catName=%A1%BE%EA%D1%CD%A9%CE%C4%B7%BF%A1%BF"  target="_blank">查看更多</a></li>
                            </ul>
                        </li>
                        <li class="nav-hover">
                            <a href="http://xuantong.cn/article" target="_blank">关于我们  <b class="caret"></b></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="http://xuantong.cn/article/category/teacher"  >关于林曦老师</a></li>
                                <li><a href="http://xuantong.cn/article/category/classroom"  >关于暄桐教室</a></li>
                                <li><a href="http://xuantong.cn/article/category/classmates"  >写字的人</a></li>
                                <li><a href="http://xuantong.cn/article/category/calligraphy"  >写字这件事</a></li>
                            </ul>
                        </li>          </ul>
                </div>
            </div>
            <a href="/" class="navbar-brand">
                <img src="https://sce4a8b6c0d93v-sb-qn.qiqiuyun.net/files/../files/system/2017/11-14/17151976bafc671465.png">
            </a>
        </div>
                ...
                <ul class="nav user-nav">
                    <li class="user-avatar-li nav-hover visible-xs">
                        <a href="javascript:;" class="dropdown-toggle">
                            <img class="avatar-xs" src="//sce4a8b6c0d93v-sb-qn.qiqiuyun.net/assets/img/default/avatar.png?version=8.2.4_19">
                        </a>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="hidden-xs"><a href="/login?goto=/">登录</a></li>
                    <li class="hidden-xs"><a href="/register?goto=/">注册</a></li>
                </ul>
            ...
            <div class="course-filter" id="course-filter">
                <ul class="nav nav-pills hidden-xs" role="tablist">
                    ...
                    <li role="presentation"
                        ...
                        data-url="/course/search?categoryId=1&amp;orderBy=recommendedSeq"
                        data-type="course"><a href="javascript:;">默认分类</a></li>
                </ul>
                ...
                <div class="course-sort btn-group">
                    ...
                    <a href="javascript:;"
                       class="btn btn-default js-course-filter"
                       data-url="/course/search?categoryId=0&amp;orderBy=studentNum"
                       data-type='course'>
                        最热
                    </a>
                    <a href="javascript:;"
                    ...
                    <div class="panel panel-default index-article">
                        ...
                        <div class="panel-body clearfix">
                            ...
                            <ul class="index-new-article ">
                                <li class=" clearfix"><i class="es-icon es-icon-dot color-primary mrs"></i><a class="link-dark" href="/article/24" title="楷书精进，和我们爱的自由">楷书精进，和我们爱的自由</a> <span class="date">09-29</span></li>
                                <li class=" clearfix"><i class="es-icon es-icon-dot color-primary mrs"></i><a class="link-dark" href="/article/23" title="林曦老师｜演讲合辑">林曦老师｜演讲合辑</a> <span class="date">09-21</span></li>
                                <li class=" clearfix"><i class="es-icon es-icon-dot color-primary mrs"></i><a class="link-dark" href="/article/18" title="写字的人 | 不爱自己，我拿什么爱你呢？">写字的人 | 不爱自己，我拿什么爱你呢？</a> <span class="date">04-16</span></li>
                                <li class=" clearfix"><i class="es-icon es-icon-dot color-primary mrs"></i><a class="link-dark" href="/article/22" title="写字的人 | 我的进步奖">写字的人 | 我的进步奖</a> <span class="date">04-17</span></li>
                                <li class="last clearfix"><i class="es-icon es-icon-dot color-primary mrs"></i><a class="link-dark" href="/article/17" title="写字的人 | “随性的，但也真喜欢”">写字的人 | “随性的，但也真喜欢”</a> <span class="date">04-13</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <footer class="es-footer">
        <div class="copyright text-sm">
            <div class="container">
                Powered by <a href="/" target="_blank">毫秒学院</a>
...
<div class="es-bar hidden-xs">
    ...
    <div class="es-bar-menu">
        <ul class="bar-menu-top">
            ...
            </li>    <li data-id="#bar-course-list" data-placement="left" data-toggle="tooltip" title="我的课程/全阶课程" data-trigger="hover" data-container=".es-bar">
    ...
    <div class="bar-popover-content" style="display:none;">
        ...
        <div id="bar-phone-content">
            <p class="mtm"><i class="es-icon es-icon-mail mrm"></i>邮箱： <a class="link-dark" href="mailto:xuantonglearning@126.com">xuantonglearning@126.com</a></p>
        </div>
