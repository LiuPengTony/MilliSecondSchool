...
! function(e, a) {
    ...
    function e(e, a) {
        var s, n = p.placeHolderPrefix,
            t = p.placeHolderSuffix;
        for(s in a) {
            var c = new RegExp(n + s + t, "g");
            c.test(e) && (e = e.replace(c, a[s]))
        }
        return e
    }

    function a(e, a, n, t, c) {
        var r = n || t || c,
            i = a,
            u = r.split("_")[0];
        if(!(r in l))
        ...
        if("undefined" == typeof i || null === i)
            for(var o = 0; o < f.length; o++)
                if(s(r, f[o], e) || s(u, f[o], e) || s(c, f[o], e)) {
                    i = f[o];
                    break
                }
        if(s(r, i, e)) return l[r][i][e];
        for(var d, h, p, m; r.length > 2 && (d = r.length, h = r.split(/[\s_]+/), p = h[h.length - 1], m = p.length, 1 !== h.length);)
            if(r = r.substring(0, d - (m + 1)), s(r, i, e)) return l[r][i][e];
        return s(c, i, e) ? l[c][i][e] : e
    }
    ...
    function n(e, a, s) {
        ...
        for(n = 0; n < u.length; n++) {
            var m = u[n];
            d.test(m) ? (f = m.match(d), i[f[0]] = f[f.length - 1]) : o.test(m) ? (f = m.match(o), l.push(f[1])) : l.push(m)
        }
        for(r in i)
            if(h.test(r))
                if(f = r.match(h), f[1]) {
                    ...
                    var b = t(f[4]),
                        k = t(f[5]);
                    if(("[" === f[3] ? a >= b : a > b) && ("]" === f[6] ? a <= k : a < k)) return i[r]
                }
        return l[c(a, s)] || l[0] || void 0
    }
    ...
    var l = {},
        ...
        f = [],
        o = new RegExp(/^\w+\: +(.+)$/),
        d = new RegExp(/^\s*((\{\s*(\-?\d+[\s*,\s*\-?\d+]*)\s*\})|([\[\]])\s*(-Inf|\-?\d+)\s*,\s*(\+?Inf|\-?\d+)\s*([\[\]]))\s?(.+?)$/),
        h = new RegExp(/^\s*(\{\s*(\-?\d+[\s*,\s*\-?\d+]*)\s*\})|([\[\]])\s*(-Inf|\-?\d+)\s*,\s*(\+?Inf|\-?\d+)\s*([\[\]])/),
        p = {
            locale: i(),
            fallback: u,
            placeHolderPrefix: "%",
            ...
            add: function(e, a, s, n) {
                var t = n || this.locale || this.fallback,
                    c = s || this.defaultDomain;
                return l[t] || (l[t] = {}), l[t][c] || (l[t][c] = {}), l[t][c][e] = a, !1 === r(f, c) && f.push(c), this
            },
            trans: function(s, n, t, c) {
                var r = a(s, t, c, this.locale, this.fallback);
                return e(r, n || {})
            },
            transChoice: function(s, t, c, r, i) {
                var l = a(s, r, i, this.locale, this.fallback),
                    u = parseInt(t, 10);
                return c = c || {}, void 0 === c.count && (c.count = t), "undefined" == typeof l || isNaN(u) || (l = n(l, u, i || this.locale || this.fallback)), e(l, c)
            },
            fromJSON: function(e) {
